...
%type <node> program declList decl vardecl typeSpecifier funDecl formalDeclList formalDecl funBody localDeclList statementList statement assignStmt var expression loopStmt returnStmt compoundStmt condStmt addExpr term addop factor mulop relop funcCallExpr argList
...
funDecl		      : typeSpecifier ID LPAREN formalDeclList RPAREN funBody
                {
                  ...
                  addChild(funDeclNode, maketreeWithID(IDENTIFIER, $2));
